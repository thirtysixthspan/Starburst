...
function I = gaussian_smooth_image(I, sigma);

% this function filters an image I with a gaussian filter with 
% standard deviation sigma and a kernel width of 2.5*sigma
